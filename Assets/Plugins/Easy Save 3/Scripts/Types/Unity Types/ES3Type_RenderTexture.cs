...
namespace ES3Types
{
    ...
    public class ES3Type_RenderTexture : ES3ObjectType
    {
        ...
        protected override void WriteObject(object obj, ES3Writer writer)
        {
            ...
            //TODO WTF writer.WriteProperty("masterTextureLimit", UnityEngine.RenderTexture.globalMipmapLimit, ES3Type_int.Instance);
            ...
            foreach (string propertyName in reader.Properties)
            {
                switch (propertyName)
                {
                    ...
                    case "masterTextureLimit":
                       //TODO WTF UnityEngine.RenderTexture.globalMipmapLimit = reader.Read<System.Int32>(ES3Type_int.Instance);
                        break;
